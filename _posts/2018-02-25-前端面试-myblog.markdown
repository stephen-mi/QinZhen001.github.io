...
```
<script type="text/javascript" src="b1j6wg/defer2.js" defer>		</script>
```


```
<script type="text/javascript" src="b1j6wg/async1.js" async>
</script>
```
...
[波兰式和逆波兰式github](https://github.com/Tairraos/rpn.js/blob/master/rpn.js)
